...
class TokenType:
    ...
    PLUS = "PLUS"
    MINUS = "MINUS"
    MUL = "MUL"  # тип токена для множення
    DIV = "DIV"  # тип токена для ділення
    LPAREN = "LPAREN"  # тип токена для лівої дужки
    RPAREN = "RPAREN"  # тип токена для правої дужки
...
class Lexer:
    ...
    def get_next_token(self):
        ...
        while self.current_char is not None:
            ...
            if self.current_char == "*":  # розпізнавання символу множення
                self.advance()
                return Token(TokenType.MUL, "*")

            if self.current_char == "/":  # розпізнавання символу ділення
                self.advance()
                return Token(TokenType.DIV, "/")

            if self.current_char == "(":  # розпізнавання лівої дужки
                self.advance()
                return Token(TokenType.LPAREN, "(")

            if self.current_char == ")":  # розпізнавання правої дужки
                self.advance()
